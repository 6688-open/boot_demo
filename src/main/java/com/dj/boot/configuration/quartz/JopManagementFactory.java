package com.dj.boot.configuration.quartz;
...
@Component
public class JopManagementFactory implements Job {

    private Logger logger = LoggerFactory.getLogger(JopManagementFactory.class);
    ...
    public void execute(JobExecutionContext executorContext) throws JobExecutionException {
        ...
        try {
            //java 反射 获取bean里面的的方法
            //Method method = object.getClass().getMethod(methodName);
            //获取bean里面的所有的方法DeclaredMethods()
